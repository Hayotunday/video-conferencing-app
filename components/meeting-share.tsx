        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 p-3 rounded-lg">
            <p className="text-xs text-blue-800">
              <strong>How to join:</strong> Participants can click the link or
              go to the meeting page and enter the Meeting ID:{" "}
              <code className="bg-blue-100 px-1 rounded">{roomId}</code>
            </p>
          </div>
        </div>
      </DialogContent>
